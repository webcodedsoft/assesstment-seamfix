                                                    ...
                                                    <div className="card-inner position-relative card-tools-toggle height">
                                                        <div className="card-title-group">
                                                            ...
                                                            <div className="card-tools mr-n1">
                                                                <ul className="btn-toolbar gx-1">
                                                                    <li >
                                                                        <a href="#link" class="btn btn-primary" data-toggle="modal" data-target="#add-application"><span>Add Application</span> </a>
                                                                    </li>
                                                                    <li >
                                                            ...
                                                            <thead className="tb-odr-head">
                                                                <tr className="tb-odr-item">
                                                                    ...
                                                                    <th className="tb-odr-amount">
                                                                        <span className="tb-odr-date d-none d-md-inline-block">APPLICATION NAME</span>
                                                                    </th>
                                                                    <th className="tb-odr-amount">
                                                                        <span className="tb-odr-total">APPLICATION TYPE</span>
                                                                        <span className="tb-odr-total d-none d-md-inline-block">APPLICATION DCSC</span>
                                                                    </th>
                                                                    <th className="tb-odr-amount">
                                                                        <span className="tb-odr-total">APPLICATION PORT</span>
                                                                        <span className="tb-odr-total d-none d-md-inline-block">END POINT</span>
                                                                    </th>
                                                                    <th className="tb-odr-amount">
                                                                        <span className="tb-odr-total">HOST/SERVER</span>
                                                                    </th>
                                                                    <th className="tb-odr-info">
                                                            ...
                                                            <tbody className="tb-odr-body">
                                                                <tr className="tb-odr-item">
                                                                    ...
                                                                    <td className="tb-odr-amount">
                                                                        <span className="tb-odr-id"><em class="icon text-success ni ni-circle-fill"></em> Application name goes here</span>
                                                                    </td>
                                                                    <td className="tb-odr-amount">
                                                                ...
                                                                <tr className="tb-odr-item">
                                                                    ...
                                                                    <td className="tb-odr-amount">
                                                                        <span className="tb-odr-id"><em class="icon text-danger ni ni-circle-fill"></em> Application name goes here</span>
                                                                    </td>
                                                                    <td className="tb-odr-amount">
                                                                        <span className="tb-odr-total">
                                                                            <span>Application type</span>
